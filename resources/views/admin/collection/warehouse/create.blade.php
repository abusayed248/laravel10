...
@section('admin_content')
    ...
    <div class="row justify-content-center">
        <div class="col-xl-4 col-md-4">
			...
			<div class="row">
		        <div class="col-xl-8">
		            <h3 class="mt-4">Warehouse Add</h3>
		        </div>
	            ...
	            <form method="POST" action="{{ route('admin.warehouse.store') }}">
	                ...
	                <div class="card-body">
					  ...
					  <div class="form-group mb-3">
					    ...
					    <input type="text" value="{{ old('warehouse_name') }}" placeholder="Warehouse name..." class="form-control" id="warehouse_name" name="warehouse_name">
					  ...
					  <div class="form-group mb-3">
					    ...
					    <input type="text" value="{{ old('warehouse_phone') }}" placeholder="Warehouse phone..." class="form-control" id="warehouse_phone" name="warehouse_phone">
					  ...
					  <div class="form-group mb-3">
					    ...
					    <input type="text" value="{{ old('warehouse_address') }}" class="form-control" placeholder="Warehouse address..." id="warehouse_address" name="warehouse_address">
