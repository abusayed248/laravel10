...
@section('admin_content')
	...
	<div class="row">
        ...
        <div class="col-xl-4 text-end">
            <a href="{{ route('admin.subcategory.create') }}" class="mt-4 btn btn-sm btn-danger">+Add</a>
        </div>
    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5 text-start"> 
                                            ...
                                            <a href="{{ route('admin.subcategory.index') }}" class="btn btn-danger btn-sm">Reset</a>
                                        </div>
                                    </div>
                                </div>
                              ...
                              <tbody>
                                @if(!empty($subcategories) && $subcategories->count())
                                    ...
                                    <tr>
                                          ...
                                          <td colspan="2">
                                              <a href="{{ route('admin.subcategory.edit', $subcategory->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                                              <a href="{{ route('admin.subcategory.destroy', $subcategory->id) }}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                          </td>
                                    </tr>
                                    @endforeach
                                @else
