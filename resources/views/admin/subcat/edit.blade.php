	            ...
	            <form method="POST" action="{{ route('admin.subcategory.update', $subcategory->id) }}">
	                ...
	                <div class="card-body">
					  <div class="form-group mb-2">
					    ...
					    <select class="custom-select w-100" id="cat_id" name="cat_id">
					    	...
					    	@foreach($categories as $category)
					    		<option {{ $category->id==$subcategory->cat_id?'selected':'' }} value="{{ $category->id }}">{{ $category->cat_name }}</option>
					    	@endforeach
					    </select>
					  ...
					  <div class="form-group">
					    ...
					    <input type="text" class="form-control" value="{{ $subcategory->subcat_name }}" id="subcat_name" name="subcat_name">
